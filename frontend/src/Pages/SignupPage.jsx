...
const Signuppage=()=>{
  ...
  const validateform=()=>{
     ...
     if(form.password.length<6) return toast.error('password must be atleast 6 characters')
     if(!form.email.trim()) return toast.error('email is required')
     if(!emailRegex.test(form.email.trim())) return toast.error('please enter a valid email')
